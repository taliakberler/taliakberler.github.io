...
const vcard = () => {
  const lines = [
    ...
    contact.hasResume ? `item3.URL:${contact.resume}` : null,
    contact.hasResume ? "item3.X-ABLabel:Resume" : null,
    `item4.URL:${contact.cv}`,
    "item4.X-ABLabel:Full CV",
    `item5.URL:${CARD_URL}`,
    "item5.X-ABLabel:Digital card",
